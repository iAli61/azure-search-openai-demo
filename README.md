...
1. Run `azd env set AZURE_BOT_SETTINGS_CLIENT_SECRET {Client secret of existing Azure Bot Service}` required for the bot to work.
1. Run `azd env set AZURE_BOT_SETTINGS_CLIENT_ID {Client ID of existing Azure Bot Service}` required for the bot to work.
1. Run `azd env set AZURE_BOT_SETTINGS_TOKEN_EXCHANGE_URL {Token exchange URL of existing Azure Bot Service}` required for the bot to work.
1. Run `azd up`
